...
const NewsCard: React.FC<NewsCardProps> = ({ title, description, date, imagen }) => {
    return (
        <div className="bg-white shadow-lg rounded-lg w-80 min-h-[350px] max-h-[500px] flex flex-col justify-self-center overflow-hidden">
            ...
            <div className="p-4 flex flex-col flex-grow h-56">
                <div className="flex flex-col flex-grow h-24">
                    ...
                    <p className="text-gray-600 text-sm mt-4 break-words line-clamp-5 overflow-hidden w-full whitespace-normal">
                        {description}
                    </p>
                </div>
